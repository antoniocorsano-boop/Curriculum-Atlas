...
export const atlasResources: AtlasResource[] = [
  {
    ...
    rightsLabel: "Diritti da verificare",
    editorialStatus: "Catalogata",
...
export const publishedLessons: PublishedLesson[] = [
  ...
  },
  {
    ...
    dateLabel: "Lezione 2",
    materials: [
      { id: "m4", title: "Mappa del sistema agricolo", kind: "Infografica", resourceId: "r-tec-003", url: "/materials/2026-09-23/2c/mappa-sistema-agricolo.svg" },
